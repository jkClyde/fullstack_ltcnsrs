            ...
            <form onSubmit={handleSubmit}>
              ...
              {/*Personal Information*/}
                ...
                <DateInput
                  ...
                  onChange={
                    (name, date) => handleDateChange(name, date, 'birthdate')
                  } 
            ...
            <Box    sx={{ gridColumn: "span 4" }}>
              <Header subtitle="Child Health Information" />    
                ...
                <DateInput
                  ...
                  value={selectedDOW}
                  onChange={
                    (name, date) => handleDateChange(name, date, 'dow')
                  } 
                ...
                <DateInput
                  ...
                  onChange={
                    (name, date) => handleDateChange(name, date, 'vaccination')
                  } 
                ...
                <DateInput
                  ...
                  onChange={
                    (name, date) => handleDateChange(name, date, 'purga')
                  } 
